...
<aside class="w-60 bg-white border-r border-gray-100 min-h-screen flex flex-col fixed left-0 top-0 z-30">
    ...
    <nav class="flex-1 px-3 space-y-0.5 overflow-y-auto pb-4">
        ...
        <a href="{{ route('dashboard.index') }}" class="{{ $navLink(request()->routeIs('dashboard.*')) }}">
        ...
        @foreach([
            ['Charts',   'M3 3h18v14H3z M7 17v2M17 17v2M7 9l3 3 3-3 4 4'],
            ['Replay',   'M5 3l14 9-14 9V3z'],
            ['Heatmap',  'M12 2C9 5 7 8 7 11a5 5 0 0010 0c0-3-2-6-5-9z'],
        ...
        @foreach([
            ['Visitors',      'M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2M23 21v-2a4 4 0 00-3-3.87M16 3.13a4 4 0 010 7.75'],
            ['Events Click',  'M15 15l-7-7M8.5 8.5v7h7'],
            ['Integration',   'M10 13a5 5 0 007.54.54l3-3a5 5 0 00-7.07-7.07l-1.72 1.71M14 11a5 5 0 00-7.54-.54l-3 3a5 5 0 007.07 7.07l1.71-1.71'],
        ] as [$label, $d])
        <a href="#" class="{{ $navLink(false) }}">
            <svg class="w-4 h-4 shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
                <path d="{{ $d }}"/>
