    ...
    <div class="bg-gray-50 text-gray-900 min-h-screen flex">
        ...
        <aside class="w-60 bg-white border-r border-gray-100 min-h-screen flex flex-col fixed left-0 top-0 z-30">
            ...
            <nav class="flex-1 px-3 space-y-0.5 overflow-y-auto pb-4">
                ...
                <Link href="/" :class="navCls(comp === 'Dashboard/Index')">
                ...
                <Link href="/boards" :class="navCls(comp === 'Boards/Index')">
                ...
                <Link :href="siteHref('charts')" :class="navCls(comp === 'Analytics/Charts')">
                ...
                <Link :href="siteHref('replay')" :class="navCls(comp === 'Analytics/Replay')">
                    <svg class="w-4 h-4 shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
                ...
                <Link :href="siteHref('heatmap')" :class="navCls(comp === 'Analytics/Heatmap')">
                    <svg class="w-4 h-4 shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
                ...
                <Link :href="siteHref('feedback')" :class="navCls(comp === 'Analytics/Feedback')">
                    <svg class="w-4 h-4 shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
                ...
                <Link :href="siteHref('visitors')" :class="navCls(comp === 'Analytics/Visitors')">
                    <svg class="w-4 h-4 shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
                ...
                <Link :href="siteHref('events')" :class="navCls(comp === 'Analytics/Events')">
                    <svg class="w-4 h-4 shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
                ...
                <Link :href="siteHref('integration')" :class="navCls(comp === 'Analytics/Integration')">
                    <svg class="w-4 h-4 shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
                ...
                <Link :href="siteHref('workspace')" :class="navCls(comp === 'Workspace/Index')">
                    <svg class="w-4 h-4 shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
